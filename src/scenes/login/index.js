            ...
            <form onSubmit={handleSubmit} noValidate>
                ...
                <Grid container className={classes.buttons}>
                    ...
                    <Grid item>
                        <Button 
                        variant="contained"
                        size="large" component={Link} to="/register">DAFTAR COEG</Button>
                    </Grid>
                </Grid>

              <div className={classes.forgotPassword}>  <Typography component={Link} to="/lupa-password">LUPA PASSWORD</Typography></div>
                </form>        
        </Paper>
        </Container>
    )
